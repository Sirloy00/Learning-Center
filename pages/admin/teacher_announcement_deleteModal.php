<?php echo '
<div id="deleteannouncementModal'.$row['announcement_id'].'" class="modal fade">
<form method="post" >
  <div class="modal-dialog modal-sm" style="width:400px !important;">
    <div class="modal-content">
        ...
        <div class="modal-body">
			<div class="row">
				<div class="col-md-12">
					<input type="hidden" value="'.$row['announcement_id'].'" name="hidden_id" id="hidden_id"/>
        ...
        <div class="modal-footer">
			...
			<input type="submit" class="btn btn-primary btn-m" name="btn_delete_announcement" value="Yes"/>
        </div>
	</div>
   </div>
</form>
...
<?php
	if(isset($_POST['btn_delete_announcement']))
	{
		...
		$query = mysqli_query($con,"Delete from tblannouncement where announcement_id = '$txt_id' ");
