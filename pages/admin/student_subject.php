          ...
          <div class="card mb-3">
            ...
            <br/>
				<div class= "table-responsive">
					<table id="tblstudentsubject" style="border:solid 1px green;"class="table table-striped table-bordered">
						...
						<tbody>
						  ...
						  <?php
								 $squery = mysqli_query($con, "select *,st.images as stimg,t.images as timg,t.id as teacherid,c.class_id as cid, st.id as stid,
								  ...
								  where sc.studentid = '".$_SESSION['student_id']."' order by sc.studclass_id ASC");
