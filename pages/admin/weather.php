        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header" style = "background-color:rgb(51, 58, 65);color:white;">
              <h4><i class="fas fa-fw fa-cloud"></i>
              Weather Updates</h4>
			</div>
            <div class="card-body" style="background-color:rgb(250, 229, 138);">
				<a class="weatherwidget-io" href="https://forecast7.com/en/14d59121d11/cainta/" data-label_1="CAINTA" data-label_2="WEATHER" data-icons="Climacons Animated" data-days="5" data-theme="weather_one" >CAINTA WEATHER</a>
				<script>
