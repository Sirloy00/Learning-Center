      ...
      <ul class="sidebar navbar-nav" style="font-size: 20px;">
		...
		<li class="nav-item dropdown active">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            <a class="dropdown-item active" title = "Click here to view your lessons" href="student_lessons.php" style="color: blue;"><span>My Lessons</span></a>
          ...
          <div class="card mb-3">
            ...
            <br/>
				<div class= "table-responsive">
					<table id="tblstudentlessons" style="border:solid 1px green;"class="table table-striped table-bordered">
						...
						<tbody>
						   <?php
								...
								where l.visible = 'ON' and l.sender_name = '".$row['teacherid']."' 
                                ");
