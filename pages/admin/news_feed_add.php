          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-8">
							<form id="form" action="newsfeed_upload.php" method="post" enctype="multipart/form-data">
								...
								<textarea class="form-control" id="message" name="message" placeholder="Write a message" required /></textarea>
								</div>
								<input id="uploadImage" type="file" accept="images/*" name="image" />
								<div id="preview"><br/><img src="images/files.jpg" style="height:50px; witdth:70px;" /></div><br>
