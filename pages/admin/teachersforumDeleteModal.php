...
<div id="deleteMsgForumModal'.$row['tfid'].'" class="modal fade">
<form method="post" >
  <div class="modal-dialog modal-sm" style="width:300px !important;">
    <div class="modal-content">
        ...
        <div class="modal-footer">
			...
			<input type="submit" class="btn btn-primary btn-sm" name="btn_delete_msg" value="Yes"/>
        </div>
	</div>
   </div>
</form>
...
<?php
	if(isset($_POST['btn_delete_msg']))
	{
	    $txt_id = $_POST['hidden_id'];
	   
	    $query = mysqli_query($con,"Delete from tblteacherforum where id = '".$txt_id."' ");
