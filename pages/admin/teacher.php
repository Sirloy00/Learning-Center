            ...
            <div class="card-header"  style = "background-color:rgb(51, 58, 65);color:white;">
			  ...
			  <div class = "container" >
					...
					<div class= "table-responsive">
						...
						<table id="tblteacher"style="border:solid 1px green;"class="table table-striped table-bordered">
						<thead style="background-color: green;color:white;">
							...
							<?php
								...
								while($row = mysqli_fetch_array($squery))
								{
									...
									';	
										 ...
										 include "teacher_editModal.php";
							             include "teacher_deleteModal.php";
								    $num++;
								}
						 ...
						 <?php include "teacher_addModal.php"; ?>
