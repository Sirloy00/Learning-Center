        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header"  style = "background-color:rgb(51, 58, 65);color:white;">
			  ...
			  School Year Data Table</h4></div>
			  <div class = "container" >
				<br/>
				 <div class="box-body table-responsive">
                    <div style="padding:10px;">                   
						<button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addSYModal"><i class="fa fa-plus" aria-hidden="true"></i> Add School Year</button>  
				    </div>
                    <table id="tblschoolyear" style="border:solid 1px green;"class="table table-striped table-bordered">
                     ...
                     <?php
                        ...
                        while($row = mysqli_fetch_array($squery))
                            ...
                            echo '
                                 ...
                                 ';
                                include "schoolyear_editModal.php";
							    include "schoolyear_deleteModal.php";
                                $num++;
                            }
                    ?>
                    </tbody>
	                ...
	                <?php include "schoolyear_addModal.php"; ?>
