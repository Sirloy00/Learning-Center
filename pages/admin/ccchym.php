          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
				...
				<nav class="nav nav-pills nav-justified">
				  ...
				  <a class="nav-item nav-link active" href="#">CCC Hymn</a>
				</nav>
				<br/>
				    <!--TAB CONTENT CCC HYMN-->
				<div id="Hymn" class="tabcontent">
				<div class = "container"  style = "background-color:rgb(250, 229, 138); padding: 10px 10px 10px 10px;">
				<hr>
			    <div  style = "padding-left: 50px;padding-right: 50px; ">
				<strong><center><h3>CCC Hymn</h3></center></strong>
				<br>
				<center><audio controls>
					<source src="audio/hymn.mp3" type="audio/mpeg">
					Your browser does not support the audio element.
				</audio></center>
				<br><br>
				<center><p style = "color: black;" >Alma Mater dear all hail to thee <br> We will sing your praise and glory <br> You have led and made us fight for right 
				<br> Through your portals our future smiles so bright. <br > <br > We will praise thy name O CCC  <br> We will ever stand on defense for it  <br> We will sing thy praise dear CCC 
				<br>Through our deed we'll prove we are brave and fit. <br >  <br >We fear not tomorrow  <br> We shall not fear the rain  <br> And though we be met with sorrow  
				<br> We shall sing on and not feel the pain <br >  <br >And when our paths should separate <br> We'll have a heart for any fate <br> We'll have sweet memories that cannot die  
				<br> After we utter that jeweled word goodbye. <br >  <br >Had God keep watch 'tween thee and us <br> And keep us ever near to Him  <br> Alma Mater dear all hail to thee  
				<br> We will sing your praise and glory. <br >  <br >Ever upward and onward we will strive  <br> Loyalty and truth in our hearts will thrive <br> God blesses thee … He blesses us 
				<br> Alma Mater! <br ></p>
				</center>
