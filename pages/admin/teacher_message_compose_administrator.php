    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          <!-- Compose message to administrator -->
          <div class="card mb-3">
			...
			<div class = "container" >
				...
				<form method="post" action ="teacher_message_administrator_addfunction.php" >	
				    <div class="form-group">
					    <select  required="true"  name="ddl_administrator_recipient" id="ddl_administrator_recipient" data-style="btn-primary" class="form-control input-sm">
