          ...
          <div class="row">
            <div class="col-xl-3 col-sm-6 mb-3" >
              <div class="card text-white bg-primary o-hidden h-100">
                <div class="card-body">
                  ...
                  <div class="mr-5"><h3>Learning Materials</h3>
				   <span class="badge badge-default" style="font-size:30px;color:white;"> <?php
                             $q = mysqli_query($con, "select * from tbllearningmaterials");
                ...
                <a title="Click here!" class="card-footer text-white clearfix small z-1" style="background-color:gray;" href="admin_page_learningmaterials.php">
            ...
            <div class="col-xl-3 col-sm-6 mb-3">
              <div class="card text-white bg-primary o-hidden h-100">
                ...
                <a title="Click here!" class="card-footer text-white clearfix small z-1" style="background-color:gray;" href="student.php">
                  <span class="float-left">View Details</span>
                  <span class="float-right">
                    <i class="fas fa-angle-right"></i>
                  </span>
            ...
            <div class="col-xl-3 col-sm-6 mb-3">
              <div class="card text-white bg-primary o-hidden h-100">
                ...
                <a title="Click here!" class="card-footer text-white clearfix small z-1"style="background-color:gray;" href="teacher.php">
                  <span class="float-left">View Details</span>
                  <span class="float-right">
                    <i class="fas fa-angle-right"></i>
                  </span>
		    ...
		    <div class="col-xl-3 col-sm-6 mb-3">
              <div class="card text-white bg-primary o-hidden h-100">
                ...
                <a title="Click here!" class="card-footer text-white clearfix small z-1"style="background-color:gray;" href="subjects.php">
                  <span class="float-left">View Details</span>
                  <span class="float-right">
                    <i class="fas fa-angle-right"></i>
                  </span>
              ...
              <div class="card text-white bg-primary o-hidden h-100">
                ...
                <a title="Click here!" class="card-footer text-white clearfix small z-1"style="background-color:gray;" href="class.php">
                  <span class="float-left">View Details</span>
                  <span class="float-right">
                    <i class="fas fa-angle-right"></i>
                  </span>
              ...
              <div class="card text-white bg-primary o-hidden h-100">
                <div class="card-body">
                  ...
                  <div class="mr-5"><h3>Feedback</h3>
					  <span class="badge badge-default" style="font-size:30px"><?php
                        $q = mysqli_query($con,"SELECT * from tblfeedback");
                        $num_rows = mysqli_num_rows($q);
                        echo $num_rows;
                    ?></span>
				  </div>
                </div>
                <a title="Click here!" class="card-footer text-white clearfix small z-1"style="background-color:gray;" href="admin_feedback.php">
                  <span class="float-left">View Details</span>
                  <span class="float-right">
                    <i class="fas fa-angle-right"></i>
                  </span>
              ...
              <div class="card text-white bg-primary o-hidden h-100">
                <div class="card-body">
                  ...
                  <div class="mr-5"><h3>Client Service</h3>
					  <span class="badge badge-default" style="font-size:30px"><?php
                ...
                <a title="Click here!" class="card-footer text-white clearfix small z-1"style="background-color:gray;" href="customer_service.php">
                  <span class="float-left">View Details</span>
                  <span class="float-right">
                    <i class="fas fa-angle-right"></i>
                  </span>
              ...
              <div class="card text-white bg-primary o-hidden h-100">
                <div class="card-body">
				  ...
				  <div class="mr-5"><h3>New Messages</h3>
				    <span class="badge badge-default" style="font-size:30px"><?php
                        echo $_SESSION['admin_message_count'];
		            	 ?>
			      </span>
				  </div>
                </div>
                <a title="Click here!" class="card-footer text-white clearfix small z-1"style="background-color:gray;" href="">
                  <span class="float-left">View Details</span>
                  <span class="float-right">
                    <i class="fas fa-angle-right"></i>
                  </span>
