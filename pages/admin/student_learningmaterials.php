...
<?php include"student_headerpanel.php";?>
      ...
      <ul class="sidebar navbar-nav" style="font-size: 20px;">
		...
		<li class="nav-item dropdown active">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
			...
			<a class="dropdown-item active" title = "Click here to view all learning materials" href="student_learningmaterials.php"style="color: blue;"><span>View all learning materials</span></a>
 ...
 <div id="content-wrapper">
          ...
          <div class="card mb-3">
            ...
            <br/>
				<div class= "table-responsive">
					<table id="tblstudentlearningmaterials" style="border:solid 1px green;"class="table table-striped table-bordered">
	...
	$(document).ready(function(){
		$('#tblstudentlearningmaterials').DataTable();
	});
	</script>
  </body>
