...
<?php echo '<div id="admin_markall_messageModal" class="modal fade">
<form method="post">
...
<?php
	...
	{
	    $query = mysqli_query($con,"UPDATE message SET message_status = 'read' where receiver_name = 'administrator' ");
	    if($query == true){	
