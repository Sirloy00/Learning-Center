...
<div id="change_profile" class="modal fade">
            ...
            <div class="row"> 
			    <div class="col-md-12">
					<div class="form-group">
						<center><input type="file" class="btn btn-primary btn-m" name="image_upload" id="image_upload"/></center>
					</div>
				</div>
            </div>
		</div>
				...
				if(mysqli_error($con)){
                  ...
                  echo'
                   ...
                   $(document).ready(fuction() {
					   $("#teacher_profileModal").modal("show");
				   });
                   </script>';					  
				}
	  }
