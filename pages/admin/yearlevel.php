            ...
            <div class="card-header"  style = "background-color:rgb(51, 58, 65);color:white;">
			  ...
			  <div class = "container" >
				...
				<div class= "table-responsive">
					...
					<table id="tblyearlevel" style="border:solid 1px green;"class="table table-striped table-bordered">
                                 ...
                                 while($row = mysqli_fetch_array($squery))
                                 {
                                    echo '
                                        <tr>
                                          ...
                                          ';
                                       include "yearlevel_editModal.php";
									   include "yearlevel_deleteModal.php";
                                 $num++;          
                                 }
                         ?>
						</tbody>
				    ...
				    <?php include "yearlevel_addModal.php"; ?>
				</div>
			  </div>
			    <br/>                           
				<br/>
