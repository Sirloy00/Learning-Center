          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
				...
				<nav class="nav nav-pills nav-justified">
				  <a class="nav-item nav-link active " href="#">Board of trustees </a>
				...
				<div class="container" class="bot-margin" >         
					<center><img src="images/bot.jpg" class="img-thumbnail" alt="Board of Trustees" width="100%" height="auto"></center>
				</div>
