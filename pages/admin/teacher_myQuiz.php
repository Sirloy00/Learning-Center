    ...
    <div id="wrapper">
      ...
      <ul class="sidebar navbar-nav" style="font-size: 20px;">
		...
		<li class="nav-item dropdown active">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            <a class="dropdown-item active" title = "Click here to manage your quiz!" href="teacher_manage_quiz.php" style="color: blue;"><i class="far fa-file-text"></i><span>&nbsp; Create Quiz</span></a>
            <a class="dropdown-item" title = "Click here to view your quiz!" href=""style="color: blue;"><i class="far fa-folder"></i><span>&nbsp;&nbsp;My Quiz</span></a>
        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header" style ="background-color:rgb(51, 58, 65);">
              <h4 style="color:white;"><i class="fas fa-folder"></i>
              My Quiz</h4></div>
            <div class="card-body" style="padding:10px;">
			<br/>
			<form method="post" action = "teacher_myQuiz.php">
						...
						<tbody>
						  <?php
                                ...
                                while($row = mysqli_fetch_array($squery))
                                {
                                    ...
                                    <tr>
										<td>
											<center><button title="Edit" name="Edit" class="btn btn-primary btn-sm" data-target="#editModal'.$row['id'].'" data-toggle="modal"><i class="far fa-edit"></i></button>
											<button title="Delete" name="delete" class="btn btn-danger btn-sm" data-target="#deleteModal'.$row['id'].'" data-toggle="modal"><i class="far fa-trash-alt"></i></button></center>
										</td>
										<td>'.$num.'</td>
