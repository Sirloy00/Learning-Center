          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
				...
				<nav class="nav nav-pills nav-justified">
				  ...
				  <a class="nav-item nav-link active" href="#">Management Commitee</a>
			    ...
			    <div class="container" class="bot-margin">         
					<center><img src="images/mm.jpg" class="img-thumbnail" alt="Management Commitee" width="912" height="708"></center>
				</div>
            </div>
