...
$receiver = 'administrator';
 echo '<div id="adminreply'.$row['message_id'].'" class="modal fade" >
<form method="post">
  <div class="modal-dialog modal-m" style="width:500px !important;">
    <div class="modal-content">
        ...
        <div class="modal-body" style="height:470px;width:499px;border:solid 1px blue;overflow:scroll;overflow-x:hidden;overflow-y:scroll;">';
			...
			$squery2 = mysqli_query($con, "select * from message where receiver_name = 'administrator' and sender_name = '".$_SESSION['sender_name']."' or receiver_name = '".$_SESSION['sender_name']."' and sender_name = 'administrator' order by message_id ASC");
