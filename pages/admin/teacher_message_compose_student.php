        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
			...
			<div class = "container" >
				...
				<form method="post" action ="teacher_message_student_addfunction.php" >	
				    <div class="form-group">
					    <select  required="true"  name="ddl_student_recipient" id="ddl_student_recipient" data-style="btn-primary" class="form-control input-sm">
                            <option value ="" selected disabled>-- Select Recipient --</option>
                            <?php
						        $q = mysqli_query($con,"SELECT *, st.id as stid,sc.studclass_id as sid, CONCAT(st.fname, ' ', st.mname, ' ',st.lname) as sname 
							         from tblstudentclass sc left join tblstudent st on sc.studentid = st.id where sc.teacherid = '".$_SESSION['id']."'
