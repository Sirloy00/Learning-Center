  ...
  <div class="modal-dialog modal-sm" style="width:300px !important;">
    <div class="modal-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="form-group">
						...
						<input name="txt_edit_studentnumber" id="txt_edit_pass" class="form-control input-sm" type="number" value="'.$row['student_number'].'" />
					</div>
					<div class="form-group">
						<label>OR Number: </label>
						<input name="txt_edit_ornum" id="txt_edit_pass" class="form-control input-sm" type="number" value="'.$row['or_number'].'" />
					</div>
				</div>
			</div>
        </div>
        <div class="modal-footer">
            ...
            <input type="submit" class="btn btn-primary btn-sm" name="btn_updatestudent" value="Save"/>
		</div>
    </div>		
	</div>	
...
if(isset($_POST['btn_updatestudent'])){
		...
		if(!empty($_POST['name']) || !empty($_FILES['image']))
		{
				...
				if($errorimg > 0){
						...
						$txt_edit_studentnumber = $_POST['txt_edit_studentnumber'];
						$txt_edit_ornum = $_POST['txt_edit_ornum'];

						$query = mysqli_query($con,"UPDATE tblstudent SET  fname = '".$txt_edit_fname."', mname = '".$txt_edit_mname."', lname = '".$txt_edit_lname."', contact = '".$txt_edit_contact."', address = '".$txt_edit_addr."', username = '".$txt_edit_uname."', password = '".$txt_edit_pass."',
						student_number = '".$txt_edit_studentnumber."',or_number = '".$txt_edit_ornum."'  where id = '".$txt_id."' ");
			...
			$path = $path.strtolower($final_image); 
					...
					if(move_uploaded_file($tmp,$path)) 
					{
						...
						$query2 = mysqli_query($con,"UPDATE tblstudent SET images = '".$path."', fname = '".$txt_edit_fname."', mname = '".$txt_edit_mname."', lname = '".$txt_edit_lname."', contact = '".$txt_edit_contact."', address = '".$txt_edit_addr."', username = '".$txt_edit_uname."', password = '".$txt_edit_pass."',
						student_number = '".$txt_edit_studentnumber."',or_number = '".$txt_edit_ornum."'  where id = '".$txt_id."' ");
						if($query2 == true){
							$_SESSION['edit'] = 1;
		    ...
		    $txt_id = $_POST['hidden_id'];
						...
						$query3 = mysqli_query($con,"UPDATE tblstudent SET fname = '".$txt_edit_fname."', mname = '".$txt_edit_mname."', lname = '".$txt_edit_lname."', contact = '".$txt_edit_contact."', address = '".$txt_edit_addr."', username = '".$txt_edit_uname."', password = '".$txt_edit_pass."',
						student_number = '".$txt_edit_studentnumber."',or_number = '".$txt_edit_ornum."'  where id = '".$txt_id."' ");
						if($query3 == true){
							$_SESSION['edit'] = 1;
