      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Teacher Advisory</li>
          </ol>
          ...
          <div class="card mb-3">
            <div class="card-header"  style = "background-color:rgb(51, 58, 65);color:white;">
			  ...
			  Home Room Teacher Data Table</h4></div>
			  <div class = "container" >
				<br/>
				<div class= "table-responsive">
				    <div style="padding:10px;">                   
						<button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addteachAdModal"><i class="fa fa-plus" aria-hidden="true"></i> Add Teacher Advisory</button>  
                    </div> 
					<table id="tblteacheradvisory" style="border:solid 1px green;"class="table table-striped table-bordered">
						...
						<?php
						   $num = 1;
                           $squery = mysqli_query($con, "select *,t.images as timg,c.class_id as cid, t.id as tid, sb.s_id as sbid, ta.teachad_id as taid,CONCAT(t.lname, ', ', t.fname, ' ',t.mname) as tname from tblteacheradvisory ta left join tblteacher t on ta.teacherid = t.id left join tblclass c on ta.classid = c.class_id left join tblsubjects sb on ta.subjectid = sb.s_id");
                           while($row = mysqli_fetch_array($squery))
                           {
                                echo '
                                <tr>
                                    <td>
									    <center><button name="Edit" class="btn btn-primary btn-sm" data-target="#editModal'.$row['taid'].'" data-toggle="modal"><i class="far fa-edit"></i></button>
				                        <button name="Edit" class="btn btn-danger btn-sm" data-target="#deleteModal'.$row['taid'].'" data-toggle="modal"><i class="far fa-trash-alt"></i></button></center>
								    </td>
									<td>'.$num.'</td>
                                ...
                                ';
                                include "teacheradvisory_editModal.php";
                                include "teacheradvisory_deleteModal.php";	
								$num++;
                           }
                        ?>
						</tbody>
					 ...
					 <?php include "teacheradvisory_addModal.php"; ?>
				</div>
			  </div>
			    <br/>                           
				<br/>
